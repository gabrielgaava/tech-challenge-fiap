...
@Component
public class MercadoPagoCheckoutDriver implements CheckoutGateway {
    ...
    public MercadoPagoCheckoutDriver(HandleExternalPaymentUseCase handleExternalPaymentUseCase,
