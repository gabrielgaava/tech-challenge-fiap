...
@Service
public class MercadoPagoCheckoutAdapter implements ICheckoutGateway {

  private final IHandleExternalPaymentUseCase handleExternalPaymentUseCase;
  private final String GATEWAY_NAME = "MERCADOPAGO";

  public MercadoPagoCheckoutAdapter(IHandleExternalPaymentUseCase handleExternalPaymentUseCase) {
